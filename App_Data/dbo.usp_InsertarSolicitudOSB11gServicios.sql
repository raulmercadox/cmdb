create procedure dbo.usp_InsertarSolicitudOSB11gServicios
@solicitudid int,
@numeroarchivo int,
...
as
insert into dbo.SolicitudOSB11gServicios (SolicitudId,NumeroArchivo,Responsable,AnalistaDesarrollo,RutaOrigen,Accion,NombreJar,ProyectoServicio,Observacion,ParametrosAmbiente)
