...
{
    public class SolicitudOSB10gRepository:Repository
    {
        public SolicitudOSB10gRepository()
        {
        }

        public SolicitudOSB10gRepository(string cadcon)
            : base(cadcon)
        {
        }

        public void InsertarCab(SolicitudOSB10gCab cab)
        {
            var cmd = new SqlCommand("dbo.usp_InsertarSolicitudOSB10gCab", this.Conexion);
        ...
        public void InsertarServicios(SolicitudOSB10gServicios servicios)
        {
        ...
        public void InsertarAplicaciones(SolicitudOSB10gAplicaciones aplicaciones)
        {
            var cmd = new SqlCommand("dbo.usp_InsertarSolicitudOSB10gServicios", this.Conexion);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void EliminarObjetos(int solicitudId, int numeroArchivo)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("dbo.usp_EliminarSolicitudOSB10gCab", this.Conexion);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                this.Conexion.Open();
                cmd.ExecuteNonQuery();
                cmd.CommandText = "dbo.usp_EliminarSolicitudSolicitudOSB10gServicios";
                cmd.ExecuteNonQuery();
                cmd.CommandText = "dbo.usp_EliminarSolicitudSolicitudOSB10gAplicaciones";
                cmd.ExecuteNonQuery();
                this.Conexion.Close();
            }
            catch
