...
{
    public class SolicitudReportesRepository:Repository
    {
        public SolicitudReportesRepository()
        {
        }

        public SolicitudReportesRepository(string cadcon)
            : base(cadcon)
        {

        }

        public void InsertarCab(SolicitudReportesCab cab)
        {
            var cmd = new SqlCommand("dbo.usp_InsertarSolicitudReportesCab", this.Conexion);
        ...
        public void InsertarDetalle(SolicitudReportesDetalle detalle)
        {
            var cmd = new SqlCommand("dbo.usp_InsertarSolicitudReportesDetalle", this.Conexion);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void EliminarObjetos(int solicitudId, int numeroArchivo)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("dbo.usp_EliminarSolicitudReportesCab", this.Conexion);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                this.Conexion.Open();
                cmd.ExecuteNonQuery();
                cmd.CommandText = "dbo.usp_EliminarSolicitudReportesDetalle";
                cmd.ExecuteNonQuery();
                this.Conexion.Close();
            }
            catch
