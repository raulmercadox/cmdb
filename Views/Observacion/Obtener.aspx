...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form name="frmDatosObservacion" id="frmDatosObservacion" method="post" action="<%=Url.Content("~/Observacion/Actualizar") %>" class="form-horizontal">
        ...
        <div class="panel-footer">
            <input type="button" class="btn btn-primary" name="btnActualizarObservacion" id="btnActualizarObservacion" value="Actualizar" />
        </div>
    </div>
