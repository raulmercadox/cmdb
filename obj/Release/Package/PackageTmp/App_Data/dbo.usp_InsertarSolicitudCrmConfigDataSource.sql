create procedure dbo.usp_InsertarSolicitudCrmConfigDataSource
@solicitudid int,
@numeroarchivo int,
...
as
insert into dbo.SolicitudCrmConfigDataSource (SolicitudId,NumeroArchivo,Responsable,AnalistaDesarrollo,Accion,Nombre,ServerCluster,JndiName,Url,DriverClassName,[User],
