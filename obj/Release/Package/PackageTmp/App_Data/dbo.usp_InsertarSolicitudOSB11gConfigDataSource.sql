create procedure dbo.usp_InsertarSolicitudOSB11gConfigDataSource
@Id int,
@SolicitudId int,
@NumeroArchivo int,
...
as
insert into dbo.SolicitudOSB11gConfigDataSource (SolicitudId,NumeroArchivo,Responsable,AnalistaDesarrollo,Accion,Nombre,ServerCluster,JNDIName,URL,DriverClassName,[User],
