create procedure dbo.usp_InsertarSolicitudSOAConfigCertificados
@SolicitudId int,
@NumeroArchivo int,
...
as
insert into dbo.SolicitudSOAConfigCertificados (SolicitudId,NumeroArchivo,Responsable,AnalistaDesarrollo,Accion,Nombre,RutaOrigen,RutaDestino,ServidoresDestino,Observacion)
