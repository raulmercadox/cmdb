...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Datos del Tipo de Acción de BD</h3>
        </div>
        <div class="panel-body">
            <form name="frmDatosTipoAccionBD" id="frmDatosTipoAccionBD" method="post" action="<%=Url.Content("~/TipoAccionBD/Actualizar") %>" class="form-horizontal">
        ...
        <div class="panel-footer">
            <input type="button" class="btn btn-primary" name="btnActualizarTipoAccionBD" id="btnActualizarTipoAccionBD" value="Actualizar" />
        </div>
    </div>
