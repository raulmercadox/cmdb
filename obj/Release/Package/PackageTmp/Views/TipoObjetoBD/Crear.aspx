...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Crear Tipo de Objeto de BD</h3>
        </div>
        <div class="panel-body">
            <form name="frmNuevaTipoObjetoBD" id="frmNuevaTipoObjetoBD" method="post" action="<%=Url.Content("~/TipoObjetoBD/Crear") %>" class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="txtNombreTipoObjetoBD" class="col-xs-3 col-sm-2 col-md-3 col-lg-2 control-label">Extension:</label>
                    <div class="col-xs-9 col-sm-9 col-md-8 col-lg-6">
        ...
        <div class="panel-footer">
            <input type="button" class="btn btn-primary" name="btnCrearTipoObjetoBD" id="btnCrearTipoObjetoBD" value="Crear" />
        </div>
    </div>
