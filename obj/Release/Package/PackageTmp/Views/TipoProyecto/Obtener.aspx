...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Datos del Tipo de Proyecto</h3>
        </div>
        <div class="panel-body">
            <form name="frmDatosTipoProyecto" id="frmDatosTipoProyecto" method="post" action="<%=Url.Content("~/TipoProyecto/Actualizar") %>" class="form-horizontal">
        ...
        <div class="panel-footer">
            <input type="button" class="btn btn-primary" name="btnActualizarTipoProyecto" id="btnActualizarTipoProyecto" value="Actualizar" />
        </div>
    </div>
